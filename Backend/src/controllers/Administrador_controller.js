...
const actualizar = async (req, res) => {
    ...
    try {
        ...
        res.status(200).json({ msg: `Perfil actualizado correctamente${extraMsg}`, admin: adminActualizado });
    } catch (error) {
